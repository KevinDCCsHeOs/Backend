...
export default function Home() {
  ...
  // nuevo estado para el video del Plan México
  const [mostrarVideoPlan, setMostrarVideoPlan] = useState(false);
  ...
  function responderInicial(respuesta) {
    ...
    // Podrías usar esCorrecta si quieres registrar algo
    ...
    <div className="home">
      ...
      <div className="hero-wrapper">
        <section className="hero">
          <div className="hero-left">
            ...
            <h1 className="hero-title">Prosperidad para todas y todos</h1>
            <p className="hero-subtitle">
              Descubre cómo se generan empleos, qué proyectos vienen, dónde
              habrá inversión y cómo todo esto te puede beneficiar a ti, a tu
              comunidad o a tu negocio.
            </p>
      ...
      <section className="info-cards">
        <article className="info-card">
          ...
          <p>
            Una guía simple y actualizada sobre la visión y los objetivos del
            Plan. ¿Para qué sirve? ¿A quién beneficia? ¿Qué cambios traerá para
            el país?
          </p>

          {/* Botón que muestra el video de TikTok dentro de la app */}
          {!mostrarVideoPlan && (
            <button
              className="link-btn"
              onClick={() => setMostrarVideoPlan(true)}
            >
              Ver video
            </button>
          )}
          ...
          {mostrarVideoPlan && (
            <div className="video-container">
              <iframe
                src="https://www.tiktok.com/embed/v2/7577307929087462677"
                title="Video: ¿Qué es el Plan México?"
                frameBorder="0"
        ...
        <article className="info-card">
          ...
          <p>
            Conoce los proyectos prioritarios, carreteras, energías limpias,
            polos productivos y programas que impulsan el desarrollo justo y
            sustentable.
          </p>
        ...
        >
          ...
          >
            ...
            <div className="vf-buttons">
              <button onClick={() => responderInicial("Verdadero")}>
                Verdadero
              </button>
              <button onClick={() => responderInicial("Falso")}>
                Falso
              </button>
            </div>
      ...
      {modalFinalAbierto && noticiaActiva && (
        <div
          className="modal-overlay"
          onClick={() => setModalFinalAbierto(false)}
        >
          <div
            className="modal-card"
            onClick={(e) => e.stopPropagation()}
          >
            {/* cuando aún no se ha respondido */}
            {!respuestaCorrecta && respuestaCorrecta !== false && (
              <>
                ...
                <div className="vf-buttons">
                  <button onClick={() => responderFinal("Verdadero")}>
                    Verdadero
                  </button>
                  <button onClick={() => responderFinal("Falso")}>
                    Falso
                  </button>
                </div>
              </>
            ...
            {respuestaCorrecta !== null && (
              <>
                ...
                <p style={{ marginTop: "10px" }}>
                  Sigue explorando la plataforma para conocer más sobre el
                  Plan México y cómo te beneficia.
                </p>
